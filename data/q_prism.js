// data/q_prism.js — 각기둥과 각뿔
window.Q_prism = [
  {
    id: 'prism-1', unit: 'prism', level: 1,
    q: '삼각기둥의 면은 모두 몇 개일까?',
  ...
  {
    id: 'prism-5', unit: 'prism', level: 2,
    q: '사각뿔의 면은 모두 몇 개일까?',
    answer: '5', answerLabel: '5개',
    hint1: '밑면(사각형) 1개와, 옆을 이루는 삼각형 면들을 세어봐.',
    hint2: '밑면 1개 + 옆면(삼각형) 4개.',
    think: '각뿔의 옆면은 항상 어떤 모양일까?',
  },
  {
    id: 'prism-6', unit: 'prism', level: 3,
    q: '면이 7개인 각기둥의 밑면은 몇 각형일까?',
    answer: '5', answerLabel: '오각형 (5)',
    hint1: '각기둥의 면 = 밑면 2개 + 옆면. 옆면 수는 밑면의 변의 수와 같아.',
    hint2: '7 - 2 = 5. 옆면이 5개면 밑면은 몇 각형일까?',
    think: '거꾸로 생각하기: 면의 수에서 밑면 모양을 알아내는 과정을 정리해봐.',
  },
];

// data/q_graph.js — 여러 가지 그래프
window.Q_graph = [
  {
    id: 'graph-1', unit: 'graph', level: 1,
    q: '띠그래프 전체는 몇 %를 나타낼까?',
  ...
  {
    id: 'graph-2', unit: 'graph', level: 1,
    q: '원그래프에서 한 항목이 전체의 1/4을 차지하면 몇 %일까?',
    answer: '25', answerLabel: '25%',
    hint1: '1/4을 백분율로 바꿔봐.',
    hint2: '1/4 × 100 = ?',
    think: '원그래프에서 1/4은 원의 각도로 몇 도일까?',
  },
  {
    id: 'graph-3', unit: 'graph', level: 2,
    q: '어떤 항목이 30%, 다른 항목이 45%, 나머지 한 항목은 몇 %일까?',
    answer: '25', answerLabel: '25%',
  ...
  {
    id: 'graph-4', unit: 'graph', level: 2,
    q: '40명 중 25%가 축구를 좋아해. 몇 명일까?',
    answer: '10', answerLabel: '10명',
    hint1: '25%는 비율로 1/4이야.',
    hint2: '40의 1/4은? 또는 40 × 0.25 를 계산해봐.',
    think: '백분율로 실제 인원을 구할 때 어떤 계산을 했어?',
  },
  {
    id: 'graph-5', unit: 'graph', level: 3,
    q: '띠그래프에서 A가 전체의 20%이고 8명일 때, 전체는 몇 명일까?',
    answer: '40', answerLabel: '40명',
    hint1: '20%가 8명이라는 걸 이용해. 1%는 몇 명일까?',
    hint2: '8 ÷ 20 = 0.4 명이 1%. 100%는 0.4 × 100.',
    think: '부분과 백분율을 알 때 전체를 구하는 방법을 정리해봐.',
  },
];

// data/q_volume.js — 직육면체의 부피와 겉넓이
window.Q_volume = [
  {
    id: 'volume-1', unit: 'volume', level: 1,
  ...
  {
    id: 'volume-2', unit: 'volume', level: 1,
  ...
  {
    id: 'volume-3', unit: 'volume', level: 2,
    q: '가로 4, 세로 4, 높이 2 인 직육면체의 부피는?',
    answer: '32', answerLabel: '32',
    hint1: '밑면(가로×세로)을 먼저 구하고 높이를 곱해봐.',
    hint2: '4 × 4 = 16, 거기에 높이 2를 곱하면?',
    think: '"밑면의 넓이 × 높이"로도 부피를 구할 수 있는 이유는?',
  },
  {
    id: 'volume-4', unit: 'volume', level: 2,
  ...
  {
    id: 'volume-5', unit: 'volume', level: 3,
    q: '가로 5, 세로 3, 높이 2 인 직육면체의 겉넓이는?',
    answer: '62', answerLabel: '62',
    hint1: '마주 보는 면이 3쌍이야: (가로×세로), (가로×높이), (세로×높이).',
    hint2: '(5×3 + 5×2 + 3×2) 를 구한 뒤 2를 곱해봐.',
    think: '왜 세 가지 면을 구하고 2배를 할까? 직육면체를 펼쳐서 떠올려봐.',
  },
  {
    id: 'volume-6', unit: 'volume', level: 3,
    q: '부피가 27 인 정육면체의 한 모서리 길이는?',
    answer: '3', answerLabel: '3',
